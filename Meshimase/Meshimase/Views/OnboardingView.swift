...
struct OnboardingView: View {
    ...
    private let pages: [OnboardingPage] = [
        .init(emoji: "🕒",
              title: "時間に合わせて、ごはん提案",
              body: "朝・昼・夜、アプリを開いた時間に合わせて1品ランダムに選びます。"),
        .init(emoji: "🎛",
              title: "気分を3つ選ぶだけ",
              body: "ボリューム・温度・ジャンルをゆるっと選べば、気分に合う料理をガチャで提案。"),
        .init(emoji: "🗺",
              title: "決まったら、近くのお店へ",
              body: "「これにする」を押すと、周辺の候補店を一覧表示。タップで地図アプリに連携します。"),
        .init(emoji: "💴",
              title: "3回以上迷うと、決断料",
              body: "2回までは無料。3回目からは1回 100円、または月額 480円で回し放題。")
    ]
